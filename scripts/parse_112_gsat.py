...
SUBJECT_META = {
    "自然": {"md": "自然.md", "title": "112 學年度學科能力測驗 - 自然考科", "duration": 110},
    "社會": {"md": "社會.md", "title": "112 學年度學科能力測驗 - 社會考科", "duration": 110}
}
...
def process_images(text, subject_key):
    def repl(m):
        ...
        dest_rel = Path(f"images/ceec/112/{subject_key}/{src_path.name}")
        ...
        if src_path.exists():
            ...
            return f'<br><img src="/images/ceec/112/{subject_key}/{src_path.name}" style="max-width:100%; display:block; margin:10px 0;">'
...
def run_conversion():
    base_md = Path("/home/toymsi/documents/examination/大學入學考試/md/112/學測")
    output_dir = Path("/home/toymsi/documents/examination/Github/ai-sch-exam/public/json/ceec/112/學測")
