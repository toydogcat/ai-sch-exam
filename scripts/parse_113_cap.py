...
def run_conversion():
    base_md = Path("/home/toymsi/documents/examination/國中教育會考/md/113")
    output_dir = Path("/home/toymsi/documents/examination/Github/ai-sch-exam/public/json/cap/113")
    ...
    for sub, dur in subjects.items():
        ...
        print(f"Parsing {sub}...")
        data = parse_markdown_to_json(md_file, "113", sub, f"113 年國中教育會考 - {sub}", dur)
