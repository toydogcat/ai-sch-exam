...
SUBJECT_META = {
    "國寫": {"md": "國寫.md", "title": "114 學年度學科能力測驗 - 國語文寫作能力測驗", "duration": 90},
    "國綜": {"md": "國綜.md", "title": "114 學年度學科能力測驗 - 國語文綜合能力測驗", "duration": 90},
    "英文": {"md": "英文.md", "title": "114 學年度學科能力測驗 - 英文考科", "duration": 100},
    "數A": {"md": "數A.md", "title": "114 學年度學科能力測驗 - 數學A考科", "duration": 100},
    "數B": {"md": "數B.md", "title": "114 學年度學科能力測驗 - 數學B考科", "duration": 100},
    "社會": {"md": "社會.md", "title": "114 學年度學科能力測驗 - 社會考科", "duration": 110},
    "自然": {"md": "自然.md", "title": "114 學年度學科能力測驗 - 自然考科", "duration": 110},
}
...
def process_images(text, subject_key):
    def repl(m):
        ...
        dest_rel = Path(f"images/ceec/114/學測/{subject_key}/{src_path.name}")
        ...
        if src_path.exists():
            ...
            return f'<br><img src="/images/ceec/114/學測/{subject_key}/{src_path.name}" style="max-width:100%; display:block; margin:10px 0;">'
...
def run_conversion():
    base_md = Path("/home/toymsi/documents/examination/大學入學考試/md/114/學測")
    output_dir = Path("/home/toymsi/documents/examination/Github/ai-sch-exam/public/json/ceec/114/學測")
