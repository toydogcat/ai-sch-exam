...
SUBJECT_META = {
    "數甲": {"md": "數甲.md", "title": "112 學年度分科測驗 - 數學甲考科", "duration": 80},
    "物理": {"md": "物理.md", "title": "112 學年度分科測驗 - 物理考科", "duration": 80},
    "化學": {"md": "化學.md", "title": "112 學年度分科測驗 - 化學考科", "duration": 80},
    "生物": {"md": "生物.md", "title": "112 學年度分科測驗 - 生物考科", "duration": 80},
    "歷史": {"md": "歷史.md", "title": "112 學年度分科測驗 - 歷史考科", "duration": 80},
    "地理": {"md": "地理.md", "title": "112 學年度分科測驗 - 地理考科", "duration": 80},
    "公民": {"md": "社會.md", "title": "112 學年度分科測驗 - 公民與社會考科", "duration": 80}
}
...
def process_images(text, subject_key):
    def repl(m):
        ...
        dest_rel = Path(f"images/ceec/112/分科/{subject_key}/{src_path.name}")
        ...
        if src_path.exists():
            ...
            return f'<br><img src="/images/ceec/112/分科/{subject_key}/{src_path.name}" style="max-width:100%; display:block; margin:10px 0;">'
...
def run_conversion():
    base_md = Path("/home/toymsi/documents/examination/大學入學考試/md/112/分科")
    output_dir = Path("/home/toymsi/documents/examination/Github/ai-sch-exam/public/json/ceec/112/分科")
    ...
    for sub_key, meta in SUBJECT_META.items():
        ...
        data = parse_markdown_to_json(md_file, "112", sub_key, meta["title"], meta["duration"])
